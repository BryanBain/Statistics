...
def areaOrValue():
    ...
    """
    print("\n1. You are trying to find area/probability/percent/etc.")
...
while quit is not True:
    ...
    if z_or_obs == 'q':
        ...
        aOrV = input()
        print()
        if aOrV == "2":  # Trying to find observed value given an area
        ...
        elif aOrV == "1":  # Trying to find area
            areaPrintout()
            x_option = input().lower()
            print()
            if x_option == "1":
    ...
    # find z score or observed value for a given area
    # elif z_or_obs == "1":
    #     invAreaPrintout()
    #     z_option = input().lower()
    #     if z_option == "1":
