...
The mean of the sample proportions ($\overline{p}$) targets the population proportion, $\rho = 0.62$.	\newline\\	\pause
...
A headache medicine claims to be 80\% effective with a standard deviation of 10\%. What is the probability that in a sample of 10 people, the medicine is at least 90\% effective?	\newline\\	\pause

$\overline{p} = 0.80$	\newline\\	\pause
$\sigma_{\overline{p}} = 0.1/\sqrt{10}$	\newline\\	\pause
$P(x \geq 90\%) \approx 0.9992$	\newline\\	\pause

There is about a 99.92\% chance the medicine is at least 90\% effective on the sample.
\end{frame}
